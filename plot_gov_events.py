...
def plot_government_events(y_number):
	...
	plt.text(x=self_iso, y= y_number, s='First self-isolation measures', alpha=0.7, color='black', rotation=90, fontsize= 9)
	...
	plt.text(x=school_close_announce, y= y_number, s='Schools close announcement', alpha=0.7, color='black', rotation=90, fontsize= 9)
	# schools closing
	school_close = pd.to_datetime('2020-03-20')
	plt.axvline(x=school_close, color='black', linestyle='dotted', linewidth=0.8)
	plt.text(x=school_close, y= y_number, s='Schools close', alpha=0.7, color='black', rotation=90, fontsize= 9)
	# stay at home order
	home = pd.to_datetime('2020-03-23')
	plt.axvline(x=home, color='black', linestyle='dotted', linewidth=0.8)
	plt.text(x=home, y= y_number, s='Lockdown starts', alpha=0.7, color='black', rotation=90, fontsize= 9)
	...
	plt.text(x=ease_1, y= y_number, s='1st easing of measures', alpha=0.7, color='black', rotation=90, fontsize= 9)     
	...
	plt.text(x=ease_2, y= y_number, s='2nd easing of measures', alpha=0.7, color='black', rotation=90, fontsize= 9)  
	...
	plt.text(x=rules_1, y= y_number, s='Self-isolation rules for UK arrivals', alpha=0.7, color='black', rotation=90, fontsize= 9)  
	...
	plt.text(x=ease_3, y= y_number, s='Reopening of shops', alpha=0.7, color='black', rotation=90, fontsize= 9)   
	...
	plt.text(x=ease_4, y= y_number, s='Reopening of pubs, meet up with 6', alpha=0.7, color='black', rotation=90, fontsize= 9) 